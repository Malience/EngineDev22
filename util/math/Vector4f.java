...
public class Vector4f extends Struct implements NativeResource {
    ...
    Vector4f(long address, ByteBuffer container) {super(address, container);}
    ...
    public static Vector4f.Buffer createSafe(long address, int capacity) {return address == NULL ? null : create(address, capacity);}
    //Stack Allocation
